...
class Payment extends \Magento\Payment\Model\Method\Cc
{
     ...
     * @param \Omnipro\EmailageLists\Helper\Data $helperEmailAge
     */
    public function __construct(
        ...
        \Omnipro\EmailageLists\Helper\Data $helperEmailAge,
        array $data = array()
    ) {
        ...
        /*Custom Fix Helper EmailAge Begin*/
        $this->helperEmailAge = $helperEmailAge;
        /*Custom Fix Helper EmailAge End*/
        ...
        $this->config_months = $this->minimum_amounts ? array(
            ...
            "15" => $this->getConfigData('fifteen_months'), //Custom Mavi
            "18" => $this->getConfigData('eighteen_months'),
            "24" => $this->getConfigData('twenty_four_months') //Custom Mavi
        ) : null;
        ...
        //Custom Mavi
        $this->configWriter->save('payment/openpay_cards/title',  "Tarjeta Crédito / Débito");
        //Custom Mavi
...
//            $charge = $openpay->charges->get($trx_id);
    ...
    public function processCapture(\Magento\Payment\Model\InfoInterface $payment, $amount) {
        ...
        $charge_request = array(
            ...
            'metadata' => $this->helperEmailAge->getEmailAgeCheckResponse( $order->getCustomerEmail() ), //Custom Fix Send Data Open_Control
            'source_id' => $token,
